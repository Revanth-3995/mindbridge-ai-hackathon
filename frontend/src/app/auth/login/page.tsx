...
import { useAuth, LoginCredentials, AuthError } from '../../../hooks/useAuth';
...
class LoginErrorBoundary extends ErrorBoundary {
  render() {
    ...
    try {
      ...
      if (authError.code === 'VALIDATION_ERROR') {
        ...
        if (authError.details?.email) {
          setError('email', { message: authError.details.email });
        }
        if (authError.details?.password) {
          setError('password', { message: authError.details.password });
        }
      }
    } finally {
